...
public class Client {
    ...
    public Client(String myQueue, String replyQueueName) throws IOException, TimeoutException {
    ...
    public Client(String myQueue) throws IOException, TimeoutException {
        response = new ArrayBlockingQueue<String>(1);
        this.myQueue = myQueue;
        factory = new ConnectionFactory();
        factory.setHost("localhost");
